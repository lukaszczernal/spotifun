...
// export const REDIRECT_URI = 'http://localhost:3000/spotifun/game'; // Your redirect uri
export const REDIRECT_URI = 'https://lukaszczernal.github.io/spotifun/game'; // Your redirect uri
